...
def drawface(x, y, k):
    imageFace = pygame.image.load('C:\Task1\homework\WORK_4\pngs\face.png')
...
def drawpandapaw1(x, y, k):
    imagePaw1 = pygame.image.load('C:\Task1\homework\WORK_4\pngs\paw1.png')
...
def drawpandapaw2(x, y, k):
    imagePaw2 = pygame.image.load('C:\Task1\homework\WORK_4\pngs\paw2.png')
...
def drawpandapaw3(x, y, k):
    imagePaw3 = pygame.image.load('C:\Task1\homework\WORK_4\pngs\paw3.png')
