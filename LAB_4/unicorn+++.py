...
rect(sr1, (98, 69, 60), (85, 210, 30, 150))  # äåðåâî
...
ellipse(sre, (255, 255, 255), (70, 200, 200, 100))  # òåëî è íîãè
...
ellipse(sre, (255, 255, 255), (200, 110, 70, 165))  # ãîëîâà
ellipse(sre, (255, 255, 255), (230, 105, 85, 43))
circle(sre, (230, 129, 171), (260, 120), 9)
circle(sre, (0, 0, 1), (258, 118), 4)
polygon(sre, (234, 235, 249), ([225, 113], [235, 5], [245, 113]))

ellipse(sre, (222, 177, 234), (185, 110, 65, 20))  # ãðèâà
...
ellipse(sre, (234, 177, 177), (180, 135, 60, 23))

ellipse(sre, (234, 177, 0), (55, 215, 60, 23))  # õâîñò
